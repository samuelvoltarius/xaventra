...
export function listBindings(cfg: typeof novaConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: typeof novaConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: typeof novaConfig) {
