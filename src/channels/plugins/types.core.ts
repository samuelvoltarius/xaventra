...
export type ChannelAgentToolFactory = (params: { cfg?: typeof novaConfig }) => ChannelAgentTool[];
...
export type ChannelMentionAdapter = {
  stripPatterns?: (params: {
    ctx: MsgContext;
    cfg: typeof novaConfig | undefined;
    agentId?: string;
  }) => string[];
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: typeof novaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: typeof novaConfig }) => boolean;
