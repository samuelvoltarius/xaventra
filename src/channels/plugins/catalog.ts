...
import { discovernovaPlugins } from "../../plugins/discovery.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { novaPackageManifest } from "../../plugins/manifest.js";
...
function toChannelMeta(params: {
  channel: NonNullable<novaPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  const manifest = candidate.packagenova;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discovernovaPlugins({ workspaceDir: options.workspaceDir });
