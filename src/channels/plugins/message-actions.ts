...
export function listChannelMessageActions(cfg: typeof novaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: typeof novaConfig): boolean {
  for (const plugin of listChannelPlugins()) {
