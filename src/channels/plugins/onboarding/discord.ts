...
function setDiscordDmPolicy(cfg: typeof novaConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setDiscordAllowFrom(cfg: typeof novaConfig, allowFrom: string[]): typeof novaConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
