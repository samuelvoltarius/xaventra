...
The [2.78.10 grounding checkpoint](docs/VERIFICATION_2.78.10.md) separates
observations from incidents and prevents advisory diagnoses from clearing failures.
